<img src="gif/huddle.gif" alt="projeto do frontend mentor feito em ReactJs usando styled-components">

# Huddle landing page

Esta é uma landing page do Frontend Mentor feita em ReactJs usando o styled-components.

# Aprendizado/usado no projeto:

* Styled-components;
* Conceitos de responsividade usando o styled-components;

## Veja o projeto completo:

https://huddle-landing-page-with-react.netlify.app/
